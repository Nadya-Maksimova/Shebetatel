          ...
          <div className="card-body p-md-5">
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <div>
<p style={{color:'red'}} id="data"></p>
</div>
                <form id="regform" action="/register" method="post" className="mx-1 mx-md-4">
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input name="confirm"type="password" id="form3Example4cd" className="form-control" />
                      <label className="form-label" htmlFor="form3Example4cd">Повторите пароль</label>
                    </div>
                  </div>
              ...
              <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="http://37.media.tumblr.com/tumblr_lybwehoJg01qhv7oho1_r1_1280.gif"
